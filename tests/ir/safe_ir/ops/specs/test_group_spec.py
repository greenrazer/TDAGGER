...
class TestGroupOutputSpec(unittest.TestCase):
    ...
    def test_negitive_dimensions(self):
        spec = GroupSpec(groups=[[1, 2, 3], [-2, -1]])
    ...
    def test_concrete_negitive_dimensions_appear_before(self):
        spec = GroupSpec(groups=[[6, 7], [-7, -6, -5]])
